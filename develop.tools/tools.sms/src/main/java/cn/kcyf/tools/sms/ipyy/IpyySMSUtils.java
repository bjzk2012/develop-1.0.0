package cn.kcyf.tools.sms.ipyy;
...
public class IpyySMSUtils {
    private IpyySMSUtils() {
    }

    private static final String DEFAULT_SMS_URL = "http://sz.ipyy.com/smsJson.aspx";
    public static String signature = "【军民融合标准资源共享平台】";
    private static final String account = "hyszzd00468";
     ...
     * @return
     */
    private static Map<String, String> buildSms(String mobile, String content, String sendTime) {
    ...
    public static String send(String phone, String content, String sendTime) {

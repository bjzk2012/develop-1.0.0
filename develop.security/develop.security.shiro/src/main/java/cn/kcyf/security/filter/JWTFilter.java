...
public class JWTFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean isLoginAttempt(ServletRequest request, ServletResponse response) {
        ...
        String authorization = req.getHeader(JWTTokenUtils.X_ACCESS_TOKEN_KEY);
    ...
    protected boolean executeLogin(ServletRequest request, ServletResponse response) {
        ...
        String authorization = httpServletRequest.getHeader(JWTTokenUtils.X_ACCESS_TOKEN_KEY);
...
//                }
    ...
    protected boolean onAccessDenied(ServletRequest request, ServletResponse response) throws Exception {
        ...
        String token = req.getHeader(JWTTokenUtils.X_ACCESS_TOKEN_KEY);

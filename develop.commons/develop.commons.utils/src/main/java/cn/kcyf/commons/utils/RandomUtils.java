...
public class RandomUtils {
    ...
    private static Random FINAL_RANDOM = new Random();
    ...
    public static long getRandom(long beginNumber, long endNumber) {
        double randomInDouble = FINAL_RANDOM.nextDouble();
        return beginNumber + (long) ((endNumber - beginNumber + 1) * randomInDouble);
    }

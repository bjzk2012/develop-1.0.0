package cn.kcyf.commons.utils.zxing;
...
public class ZXingCodeUtils {
     ...
     * @param logoConfig logo参数
     */
    public static void addLogoQRCode(File qrPic, File logoPic,
    ...
    public static BufferedImage addLogoQRCode(BufferedImage image, File logoPic,
                                              ZXingLogoConfig logoConfig) {
        try {
    ...
    public static BufferedImage addLogoWordQRCode(BufferedImage image,
                                                  String logoWord, Integer fontSize,
                                                  ZXingLogoConfig logoConfig) {
        try {
            if (image == null || StringUtils.isEmpty(logoWord)) {
                System.out.print("file not find !");
                return image;
            }
            Graphics2D g = image.createGraphics();
     ...
     *
     * @param bm          二维码对象
     * @param imageFormat 图片模版
     * @param file        生成的文件
     */
    public static void decodeQRCODE2ImageFile(BitMatrix bm, String imageFormat, File file) {
        try {
     ...
     * @return 二维码图片对象
     */
    public static BufferedImage getQRCODEBufferedImage(String content,
